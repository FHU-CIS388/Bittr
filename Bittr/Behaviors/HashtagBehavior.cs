/*
HashtagDetectorSample: https://github.com/CrossGeeks/HashtagDetectorSample
 */
using System;
using System.Linq;
...
namespace Bittr.Behaviors
{
    public class HashtagBehavior : BaseBehavior<Label>
    {
        const string Pattern = @"(?<=#)\w+";
        const string Symbol = "#";

        public static readonly BindableProperty CommandProperty =
            BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(HashtagBehavior), null, defaultBindingMode: BindingMode.TwoWay);
