...
namespace Bittr.Services
{
    public class MockDataStoreComplaint : IDataStore<Complaint>
    {
        ...
        {
            User jack = new User() { FirstName = "Reece", LastName = "Jack", Username = "gamblt589", Avatar = "profile.png" };
            User davidShannon = new User() { FirstName = "David", LastName = "Shannon", Username = "NotDavidShannon", Avatar = "profile.png" };
